...
mavenToool = ['name': 'Maven 3.6.0', 'url': 'http://www.mirrorservice.org/sites/ftp.apache.org/maven/maven-3/3.6.0/binaries/apache-maven-3.6.0-bin.tar.gz', 'subdir': 'apache-maven-3.6.0']
